...
static const _Control_type_support_symbol_names_t _Control_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, maya_msgs, msg, Control)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, maya_msgs, msg, Control)),
  }
};
...
{
  return &::maya_msgs::msg::rosidl_typesupport_cpp::Control_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, maya_msgs, msg, Control)() {
  return get_message_type_support_handle<maya_msgs::msg::Control>();
}
