...
static const _Sound_type_support_symbol_names_t _Sound_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, maya_msgs, msg, Sound)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, maya_msgs, msg, Sound)),
  }
};
...
get_message_type_support_handle<maya_msgs::msg::Sound>()
{
  return &::maya_msgs::msg::rosidl_typesupport_cpp::Sound_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, maya_msgs, msg, Sound)() {
  return get_message_type_support_handle<maya_msgs::msg::Sound>();
}
