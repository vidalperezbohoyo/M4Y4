...
{
  new (message_memory) maya_msgs::msg::Sound(_init);
}

void Sound_fini_function(void * message_memory)
{
  auto typed_message = static_cast<maya_msgs::msg::Sound *>(message_memory);
  typed_message->~Sound();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sound_message_member_array[1] = {
  {
    ...
    offsetof(maya_msgs::msg::Sound, tone),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sound_message_members = {
  "maya_msgs::msg",  // message namespace
  "Sound",  // message name
  1,  // number of fields
  sizeof(maya_msgs::msg::Sound),
...
{
  return &::maya_msgs::msg::rosidl_typesupport_introspection_cpp::Sound_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, maya_msgs, msg, Sound)() {
  return &::maya_msgs::msg::rosidl_typesupport_introspection_cpp::Sound_message_type_support_handle;
}
