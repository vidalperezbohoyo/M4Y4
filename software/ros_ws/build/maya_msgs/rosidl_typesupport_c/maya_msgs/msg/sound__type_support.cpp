...
static const _Sound_type_support_symbol_names_t _Sound_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, maya_msgs, msg, Sound)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, maya_msgs, msg, Sound)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, maya_msgs, msg, Sound)() {
  return &::maya_msgs::msg::rosidl_typesupport_c::Sound_message_type_support_handle;
}
